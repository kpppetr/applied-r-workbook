...
# Workbook: Applied R for Migration, Disaster, and Conflict Studies
...
---
title: "Lesson 1: Projects, working directory, scripts, and running code"
editor: source
---
...
ged <- read_csv("datasets/GEDEvent_v25.csv")
names(ged)
```
...
```{r}
countryyear_merged <- gdis_cy %>%
  left_join(ged_cy, by = c("gwno" = "gwnoa", "year" = "year"))
